...
import com.example.wallnoire.databinding.ItemCategoryViewBinding

class CategoryView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private fun addItem(category: Category, index: Int) {
        val item = DataBindingUtil.inflate<ItemCategoryViewBinding>(
